...
//
// 2. Check that the grid at (x, y) is kEmpty (this is the default 
//    case if the grid cell is not kClosed or a kObstacle). If both 
//    of these conditions are true, then CheckValidCell should return 
